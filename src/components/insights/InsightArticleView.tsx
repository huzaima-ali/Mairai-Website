      ...
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          {article.featured_image_url ? (
            <div className="relative mt-8 aspect-[16/9] overflow-hidden rounded-[24px] bg-surface text-left">
              <Image
